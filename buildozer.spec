...
# Read the version from pyproject.toml's `[project]` table instead of
# duplicating it here, where it silently drifted (stuck at 0.1.1 while
# pyproject.toml moved on to later releases — see the git history).
